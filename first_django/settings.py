...
SECRET_KEY = 'z!cr*_6yf)6!m+fkg1iutl!9u0=b!lpf1r=gmf13_lg4+0s@e3'
...
TEMPLATES = [
    {
        ...
        #아래 DIRS에 추가한다.
        'DIRS': [
            #BASE DIR은 16번째 줄에 정의된 변수 - 현재 프로젝트 폴더 위치를 뜻한다.
            #first- django- project 폴더임
            # first-django-project/first_django/templates/~~~
            os.path.join(BASE_DIR,'first_django', 'templates'),
        ],
        'APP_DIRS': True, #INSTALLED_APPS에 있는 app의 templates 폴더들을 템플렛으로 관리!
        'OPTIONS': {
            'context_processors': [
